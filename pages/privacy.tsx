		...
		<div>
			...
			<main className="w-[60%] m-auto">
				<div className="text-center">
					<br />
					<h1 className="font-extrabold">Privacy Policy for dailies.tk</h1>

					<p>
						At dailies.tk, accessible from https://dailies.tk, one of our main
						priorities is the privacy of our visitors. This Privacy Policy document
						contains types of information that is collected and recorded by dailies.tk
						and how we use it.
					</p>
					...
					<p>
						...
						and/or collect in dailies.tk. This policy is not applicable to any
					...
					<p>
						...
						advertising partners of dailies.tk.
					</p>
					...
					<p>
						Note that dailies.tk has no access to or control over these cookies that are
					...
					<p>
						dailies.tk does not knowingly collect any Personal Identifiable Information
