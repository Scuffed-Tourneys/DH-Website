...
const TOU = () => {
	return (
		<div>
			...
			<main className="w-[60%] m-auto">
				<div className="text-center">
					<br />
					<h1 className="font-extrabold">Website Terms and Conditions of Use</h1>

					<h2 className="font-bold">1. Terms</h2>

					<p>
						By accessing this Website, accessible from https://dailies.tk, you are
					...
					<p>
						This will let dailies.tk to terminate upon violations of any of these
						...
						it is printed or electronic format. These Terms of Service has been created
					...
					<p>
						dailies.tk or its suppliers will not be hold accountable for any damages
						that will arise with the use or inability to use the materials on
						dailies.tk’s Website, even if dailies.tk or an authorize representative of
					...
					<h2 className="font-bold">5. Revisions and Errata</h2>

					<p>
						The materials appearing on dailies.tk’s Website may include technical,
						typographical, or photographic errors. dailies.tk will not promise that any
						of the materials in this Website are accurate, complete, or current.
						dailies.tk may change the materials contained on its Website at any time
						without notice. dailies.tk does not make any commitment to update the
						materials.
					</p>
					...
					<p>
						dailies.tk has not reviewed all of the sites linked to its Website and is
						not responsible for the contents of any such linked site. The presence of
						any link does not imply endorsement by dailies.tk of the site. The use of
						any linked website is at the user’s own risk.
					</p>

					<br />

					<h2 className="font-bold">7. Site Terms of Use Modifications</h2>

					<p>
						dailies.tk may revise these Terms of Use for its Website at any time without
					...
					<h2 className="font-bold">8. Your Privacy</h2>
